...
const components = {
  ...
  "universeManager.memberHint": "Enter one symbol per line. Every universe must use one market.",
  "universeManager.manageMembers": "Manage symbols",
  "universeManager.editMembers": "Edit universe symbols",
  "universeManager.actions": "Actions",
  "universeManager.remove": "Remove",
  "universeManager.removeMemberConfirm": "Remove {symbol} from this universe?",
  "universeManager.memberRemoved": "Symbol removed.",
  "universeManager.delete": "Delete universe",
  "universeManager.deleteConfirm": "This cannot be undone. Strategies that reference this universe will need another universe. Delete it?",
  "universeManager.deleted": "Universe deleted.",
  "universeManager.deleteFailed": "Failed to delete universe.",
  "universeManager.memberMarketMismatch": "A symbol from another market was detected. A universe can contain only one market.",
  "universe.invalidMarket": "Select one market. Personal universes do not support mixed markets.",
  "universe.memberMarketMismatch": "A symbol does not match the universe market. Split different markets into separate universes.",
  "strategyIde.universeDeleted": "Universe {name} was deleted and removed from the current strategy.",
  ...
  "settings.marketCatalog.ordinarySpot": "Ordinary spot",
  "settings.marketCatalog.tokenizedEquity": "Tokenized equities",
  "settings.marketCatalog.directEquity": "Direct equities",
  "settings.marketCatalog.stockPerpetual": "Equity perpetuals",
...
const locale = {
  ...
  "marketContext.product.tokenized_equity": "Tokenized stock",
  "marketContext.product.stock_perpetual": "Stock perpetual",
  "marketContext.product.direct_equity": "Exchange stock",
  "marketContext.exchangeProductWatchlistHint": "Stocks and stock perpetuals listed by a crypto exchange are added here. Choose the venue and product type, then search the exchange symbol (for example AAPL or 00700 on Gate Spot).",
  ...
  "executorStrategies.maxOpenOrders": "Max entry orders",
  ...
  "aiAssetAnalysis.copilot.statisticalChart": "Interactive statistical chart",
  "aiAssetAnalysis.copilot.chartSeries": "Series",
  "aiAssetAnalysis.copilot.chartLine": "Line",
  "aiAssetAnalysis.copilot.chartBar": "Bar",
  "aiAssetAnalysis.copilot.subtitle": "Research symbols, inspect events, compare markets, and form testable trading views in one workspace.",
  ...
  "user.login.legal.agreePrefix": "I agree to the",
  "user.login.legal.and": "and",
  ...
  "user.resetPassword.stepVerify": "Verify identity",
  "user.resetPassword.stepSecure": "New password",
  "user.resetPassword.verifyHint": "Enter your account email and the verification code we send you.",
  "user.resetPassword.passwordHint": "Create a strong password for your account.",
  ...
  "dashboard.analysis.modal.addStock.offlineBadge": "Offline T+1 dataset ready",
  "dashboard.analysis.modal.addStock.universe": "symbols",
  "dashboard.analysis.modal.addStock.dailyBars": "daily bars",
  "dashboard.analysis.modal.addStock.example.ALL": "Mixed: search across US/CN/HK, e.g. AAPL, 600519, 00700",
  "dashboard.analysis.market.ALL": "All Markets",
  ...
  "settings.field.BILLING_COST_AI_DECISION_FILTER": "AI Decision Filter Cost",
  ...
  "settings.desc.BILLING_COST_AI_DECISION_FILTER": "Credits consumed for each completed AI pre-trade decision",
  ...
  "fastAnalysis.rechargeNow": "Top Up Now",
  ...
  "fastAnalysis.finalPlanRatio": "Recalculated from final entry, stop and target",
  "fastAnalysis.rrWarningTitle": "Risk/reward is below 1",
  "fastAnalysis.rrWarningDescription": "The potential reward is lower than the planned loss. This is a warning, not an automatic target adjustment.",
  "fastAnalysis.regimePerformanceTitle": "Market regime × decision × realized outcome (30 days)",
  ...
  "trading-assistant.logs.marketData.technicalDetail": "Show provider detail",
  "trading-assistant.logs.marketData.reason.no_market_data": "No market data",
  "trading-assistant.logs.marketData.reason.region_restricted": "Regional restriction",
  "trading-assistant.logs.marketData.reason.proxy_failure": "Proxy connection failed",
  "trading-assistant.logs.marketData.reason.symbol_not_found": "Trading pair not found",
  "trading-assistant.logs.marketData.reason.rate_limited": "Exchange rate limited",
  "trading-assistant.logs.marketData.reason.exchange_unavailable": "Exchange unavailable",
  "trading-assistant.logs.marketData.reason.incomplete_market_data": "K-line data temporarily incomplete",
  "trading-assistant.logs.marketData.reason.unsupported_timeframe": "Unsupported timeframe",
  "trading-assistant.logs.marketData.action.no_market_data": "Check the exchange status and confirm this market has recent candles.",
  "trading-assistant.logs.marketData.action.region_restricted": "Configure an authorized market-data proxy or use an exchange available in your deployment region.",
  "trading-assistant.logs.marketData.action.proxy_failure": "Check PROXY_URL, proxy protocol, credentials and network reachability.",
  "trading-assistant.logs.marketData.action.symbol_not_found": "Confirm the symbol, spot/swap type and that the pair is listed on this exchange.",
  "trading-assistant.logs.marketData.action.rate_limited": "Wait for automatic retry; reduce polling frequency if this happens repeatedly.",
  "trading-assistant.logs.marketData.action.exchange_unavailable": "Check exchange status and network connectivity; the strategy will retry automatically.",
  "trading-assistant.logs.marketData.action.incomplete_market_data": "The system is filling the missing candles and will retry automatically; recent valid data is reused only within the safe freshness limit.",
  "trading-assistant.logs.marketData.action.unsupported_timeframe": "Choose a timeframe supported by this exchange or one that QuantDinger can resample.",
  ...
  "quickTrade.spot": "Spot",
  "quickTrade.totalAssets": "Total",
  "quickTrade.connected": "Connected",
  "quickTrade.collapse": "Collapse",
  "quickTrade.openOrders": "Open Orders",
  "quickTrade.orderHistory": "Order History",
  "quickTrade.tradeHistory": "Trade History",
  "quickTrade.noOrders": "No orders yet",
...
export default {
  ...
  "strategyIde.publishBacktestPassed": "Backtest requirement met",
  "strategyIde.publishBacktestRequiredHint": "Backtesting verifies that the strategy can run and exposes basic risks. Complete a successful backtest, then return here to publish.",
  "strategyIde.publishGoBacktest": "Go to backtest",
  ...
  "strategyCenter.positionOwnership.summary": "The current account surplus is reserved from strategy exits; only strategy allocation shortfalls require attention.",
  ...
  "strategyCenter.positionOwnership.riskTitle": "Account surplus is reserved automatically",
  "strategyCenter.positionOwnership.riskDescription": "For each live snapshot, holdings above all related strategy allocations are treated as user-owned surplus. Each strategy can close only its own ledger quantity while other strategy allocations are reserved. External orders and manual trades change the next snapshot, so a material account shortfall pauses new entries.",
  "strategyCenter.positionOwnership.accountQty": "Account total",
  "strategyCenter.positionOwnership.strategyQty": "Strategy",
  "strategyCenter.positionOwnership.protectedQty": "User-owned",
  "strategyCenter.positionOwnership.unknownQty": "Coverage delta",
  ...
  "user.login.hero.edition": "AI Quant Platform",
  "user.login.hero.kicker": "AI-powered quant infrastructure",
  "user.login.hero.title": "Turn uncertain market patterns into executable trading discipline.",
  "user.login.hero.subtitle": "One workspace for market data, models, backtests, and live trading.",
  "user.login.hero.researchTitle": "AI Research Engine",
  "user.login.hero.researchDesc": "Orchestrate market data, factors, and models into reproducible research.",
  "user.login.hero.validateTitle": "Strategy Runtime",
  "user.login.hero.validateDesc": "Compile, backtest, and evaluate strategies in a consistent execution contract.",
  "user.login.hero.executeTitle": "Execution & Observability",
  "user.login.hero.executeDesc": "Coordinate signals, orders, risk controls, and audit trails across live accounts.",
  "user.login.hero.status": "AI services online",
  "user.login.hero.scope": "Data · Models · Execution",
  "user.login.hero.secureAccess": "Secure access",
  "user.login.hero.welcome": "Welcome to QuantDinger",
  "user.login.hero.welcomeDesc": "Sign in to continue your research and trading workflow.",
  "aiDecisionFilter.title": "AI Decision Filter",
  "aiDecisionFilter.strategyHint": "JEV or the configured LLM reviews entries before exchange submission. Exit orders always proceed directly.",
  "aiDecisionFilter.unsupportedStrategy": "Grid, DCA, and martingale strategies are not supported yet.",
  "aiDecisionFilter.quickTradeHint": "Buy and short actions are reviewed before submission when enabled.",
  "aiDecisionFilter.rejected": "AI blocked this trade",
  "aiDecisionFilter.rejectedHint": "The order did not pass the AI decision filter and was not sent to the exchange.",
  "aiDecisionFilter.tab": "AI Decisions",
  "aiDecisionFilter.processTitle": "AI decision history",
  "aiDecisionFilter.processHint": "Review the provider, outcome, reason, confidence, and latency for every entry check.",
  "aiDecisionFilter.noRecords": "No AI decisions yet",
  "aiDecisionFilter.provider": "Provider",
  "aiDecisionFilter.model": "Model",
  "aiDecisionFilter.confidence": "Confidence",
  "aiDecisionFilter.decisionPass": "Passed",
  "aiDecisionFilter.decisionReject": "Rejected",
  "aiDecisionFilter.decisionSkipped": "Allowed",
  "aiDecisionFilter.check.entry_decision": "Entry decision",
  "aiDecisionFilter.check.risk_check": "Risk check",
  "aiDecisionFilter.check.data_quality": "Evidence quality",
  "aiDecisionFilter.check.signal_alignment": "Signal alignment",
  "aiDecisionFilter.check.market_regime": "Market regime",
  "aiDecisionFilter.check.execution_quality": "Execution quality",
  "aiDecisionFilter.checkResult.pass": "Pass",
  "aiDecisionFilter.checkResult.reject": "Reject",
  "aiDecisionFilter.checkResult.clear": "Clear",
  "aiDecisionFilter.checkResult.caution": "Caution",
  "aiDecisionFilter.checkResult.block": "Block",
  "aiDecisionFilter.checkResult.sufficient": "Sufficient",
  "aiDecisionFilter.checkResult.partial": "Partial",
  "aiDecisionFilter.checkResult.insufficient": "Insufficient",
  "aiDecisionFilter.checkResult.aligned": "Aligned",
  "aiDecisionFilter.checkResult.mixed": "Mixed",
  "aiDecisionFilter.checkResult.conflict": "Conflict",
  "aiDecisionFilter.checkResult.favorable": "Favorable",
  "aiDecisionFilter.checkResult.neutral": "Neutral",
  "aiDecisionFilter.checkResult.adverse": "Adverse",
  "aiDecisionFilter.fallbackToLlm": "JEV was unavailable, so the configured LLM made this decision.",
  "aiDecisionFilter.providerUnavailable": "The configured AI provider was unavailable; the entry was allowed and audited.",
  "aiDecisionFilter.reason.jev_entry_approved": "JEV found no concrete reason to block this entry.",
  "aiDecisionFilter.reason.jev_entry_rejected": "JEV found a material reason to block this entry.",
  "aiDecisionFilter.reason.jev_entry_rejected:risk_block": "JEV's risk check found a material concern and blocked this entry.",
  "aiDecisionFilter.reason.jev_entry_rejected:entry_reject": "JEV's entry decision rejected this new exposure.",
  "aiDecisionFilter.reason.jev_entry_rejected:execution_block": "JEV found a concrete execution issue and blocked this entry.",
  "aiDecisionFilter.reason.jev_entry_rejected:signal_conflict": "JEV found a high-confidence conflict between the signal and market regime.",
  "aiDecisionFilter.reason.filter_disabled": "The decision filter is disabled.",
  "aiDecisionFilter.reason.exit_orders_are_not_filtered": "Exit orders bypass AI filtering.",
  "aiDecisionFilter.reason.strategy_type_not_supported": "This strategy type is not eligible for AI filtering.",
  "aiDecisionFilter.reason.ai_not_configured": "No JEV or LLM provider is configured, so the trade was allowed.",
  "aiDecisionFilter.reason.ai_provider_unavailable": "AI providers were unavailable, so the trade was allowed under the fail-open policy.",
  "aiDecisionFilter.reason.billing_insufficient_credits": "There were not enough credits to run the AI filter, so the trade was allowed without AI review.",
  "aiDecisionFilter.reason.billing_unavailable": "Billing verification was unavailable, so the trade was allowed without AI review.",
  "settings.field.JEV_API_KEY": "JEV API Key",
  "settings.field.JEV_BASE_URL": "JEV API URL",
  "settings.field.JEV_MODEL": "JEV Model",
  "settings.field.JEV_TIMEOUT_SECONDS": "JEV Decision Timeout (seconds)",
  "settings.field.JEV_MIN_CONFIDENCE": "JEV Minimum Confidence",
  "settings.desc.JEV_API_KEY": "Used for structured pre-trade decisions. JEV is preferred when configured, with the current LLM as fallback.",
  "settings.desc.JEV_BASE_URL": "Base URL for the JEV System One API.",
  "settings.desc.JEV_MODEL": "JEV model identifier used for pre-trade decisions.",
  "settings.desc.JEV_TIMEOUT_SECONDS": "Falls back to the LLM after this timeout. If all providers fail, the trade is allowed and audited.",
  "settings.desc.JEV_MIN_CONFIDENCE": "JEV results below this confidence use the configured LLM fallback instead of directly allowing or blocking an entry."
}
